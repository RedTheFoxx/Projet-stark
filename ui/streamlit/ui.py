...
st.set_page_config(layout="wide", page_title="Stark - Compte-rendus") # Mode large par défaut de streamlit et titre de page
...
col1, col2 = st.columns(2) # Deux colonnes pour aligner le champs d'upload et les radio boutons
...
with col2:
    ...
    uploaded_files = st.file_uploader(
        "Déposez vos fichiers au format .csv ou .txt",
        type=["csv", "txt"],
...
# J'avais envie
st.caption("Vince & Red - Stark © 2024 / Toute utilisation de système basé sur de l'IA générative implique des principes de précaution et de responsabilité.")